...
const fields = [
  ...
  productField("price_cents", "Retail Price Cents", "input", 2, "half", false),
  productField("cost_cents", "Private Cost Cents", "input", 3, "half", false),
  productField("category", "Category", "input", 4, "half", false),
  productField("size_label", "Size Label", "input", 5, "half", false),
  productField("short_description", "Card Description", "input-multiline", 6, "full", false),
  productField("research_overview", "Product Page Overview", "input-multiline", 7, "full", false),
  productField("purity_label", "COA Label", "input", 8, "half", false),
  productField("storage_label", "Storage Label", "input", 9, "half", false),
  productField("molecular_weight", "Molecular Weight", "input", 10, "half", false),
  productField("sequence", "Sequence", "input-multiline", 11, "full", false),
  productField("tags", "Tags", "tags", 12, "full", false),
  productField("images", "Legacy Image URLs", "tags", 13, "full", false),
  productField("technical_specs", "Technical Specs JSON", "input-code", 14, "full", false),
  productField("is_featured", "Featured", "boolean", 15, "half", false),
  productField("is_hidden", "Hidden From Storefront", "boolean", 16, "half", false),
  productField("notes", "Internal Notes", "input-multiline", 17, "full", false),
  productField("updated_by", "Updated By", "input", 18, "half", false),
  productField("created_at", "Created At", "datetime", 19, "half", false, true),
  productField("updated_at", "Updated At", "datetime", 20, "half", false, true),
