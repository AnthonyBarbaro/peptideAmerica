# 06 SEO Accessibility Performance
...
Accessibility:
- Skip link, focus rings, keyboard dialogs, and real form controls are required.
- Accessibility preferences persist in localStorage.
- Reduced motion must stop CSS animation and minimize UI motion.
